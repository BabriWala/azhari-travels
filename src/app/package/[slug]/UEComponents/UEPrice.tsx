                ...
                selectedPlan == "UE" ? <>
                    <div className='p-2 flex flex-col gap-2 bg-green-100 border rounded-md text-green-700'>
                        <div className='flex items-start gap-2'>
                            ...
                            <h3 className='font-bold'>২,১৫,০০০/- টাকা মাত্র<br /> <span className='font-medium'>(ফ্যামেলীদের জন্য - জন প্রতি)</span></h3>
                        </div>
                        <div className='flex items-start gap-2'>
                            <div>
                                <div>
                            ...
                            <h3 className='font-bold'>২,২৫,০০০/- টাকা মাত্র<br /> <span className='font-medium'>(স্বামী-স্ত্রীদের জন্য - জন প্রতি)</span> </h3>
                        </div>
                    </div>
                    ...
                    <div className='p-2 flex flex-col gap-2 bg-green-100 border rounded-md text-green-700'>
                        <div className='flex items-start gap-2'>
                            ...
                            <h3 className='font-bold'>১,৭০,০০০/- টাকা মাত্র </h3>
                        </div>
                    </div>
                </>
            }
