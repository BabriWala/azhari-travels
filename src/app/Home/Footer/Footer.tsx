                    ...
                    <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:items-center">
                        ...
                        <form className="flex flex-col gap-4 sm:flex-row">
                            <input
                                ...
                                className="h-16 flex-1 rounded-xl border border-white/20 bg-white/10 px-6 text-white outline-none transition placeholder:text-white/45 focus:border-[#F7025B] focus:bg-white/15"
                            />
