...
type Lead = { dailyWork:DailyWorkRecord[]; uploads:UploadBatch[]; conversations:LeadNote[]; notes:string; reminders:Reminder[]; id: string; name: string; phone: string; email: string | null; status: string; owner: string; source: string; form: string; labels: string; secondaryPhone: string; whatsapp: string; importedCreated: string; createdAt: string; updatedAt: string; service: string; message: string; preferredContact: string; extraFields: string; _count: { conversations: number } };
