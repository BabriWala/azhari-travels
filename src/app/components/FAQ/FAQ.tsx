...
const faqData: FAQItem[] = [
    ...
    },
    {
        ...
        answer:
            "অন এরাইভেল  ভিসা + টিকিট + অফার লেটার + রিটার্ন টিকিট মিলিয়ে মোট ১ লাখ  ৫ হাজার টাকা এবং সেখানে বাসা ভাড়া, এডভান্স, রুম চাদা  এবং ভর্তির সকল কার্যক্রমের জন্য মোট  ১৫ হাজার টাকা লাগবে",
    },
    {
    ...
    },
    {
        ...
        answer:
            "আমাদের লোক আছে তারাই বাসা ভাড়া করে দিবে এবং আপনাকে রিসিভ করা থেকে শুরি করে,  মেডিক্যাল করা, আব্বাসিয়্যাহ থেকে সিল নেওয়া, এম্বেসী লেটার নেওয়া, ভর্তি করা অর্থাৎ  সকল কাজে সহযোগীতা করবে",
    },
    {
    ...
    {
        question: "অন এরাইভেল  ভিসায় কী লেটার দিচ্ছে.?",
        answer:
            "জ্বি হ্যা দিচ্ছে.",
    },
    {
        ...
        answer:
            "২৫ ডলার যাত্রীর নিজের বহন করতে হবে ।  কারন সেটা আমাদের প্রদান করার কোন পন্থা নেই ।",
    },
    {
        question: "প্রসেসিং টা কিভাবে কী ?",
        answer:
            `<p><strong>অন এরাইভেল ভিসা:</strong></p>
    <p>প্রথমে ভিসার আবেদন করতে হবে। এর জন্য ৩০ হাজার টাকা এডভান্স দিতে হবে।</p>
    <p>তারপর ১২-১৫ দিনের মধ্যেই ভিসার এপ্রুভাল এসে যাবে, ইনশা আল্লাহ।</p>
    <p>অতপর ৩ দিনের ভিতরে টিকিট বুক করতে হবে। টিকিটের টাকা পরিশোধ করার ১ ঘন্টার মধ্যেই টিকিট দেওয়া হবে।</p>
    <p>ফ্লাইটের ১০ দিন পূর্বে বাকি টাকা পরিশোধ করতে হবে।</p>
    <p>অতঃপর ফ্লাইটের ২/৩ দিন পূর্বে ওকে টু বোর্ড প্রদান করা হবে, এবং সাথে সাথে আপনার অফার লেটার এবং রিটার্ন টিকিটও দিয়ে দেওয়া হবে।</p>`,
    },
    {
        question: "আপনাদের কী কোন অফিস বা লাইসেন্স আছে.?",
        answer:
            "আলহামদুলিল্লাহ আমাদের সরকার অনুমোদিত লাইসেন্স  আছে.. এবং আমাদের অফিস ঢাকাতেই রয়েছে",
    },
    {
        question: "পড়াশোনার পাশাপাশি কাজ করার সুযোগা আছে কিনা ?",
        answer:
            "জ্বি না নেই.. তবে অনেকেই কাজ করে টুকিটাকি, তবে একথা মনে রাখবেন কাজ করলে অবশ্যই  আপ্পনার পড়ার মধ্যে ব্যঘাত ঘটবে.. পরবর্তিতে আপনি আপনার কাংক্ষিত লক্ষ থেকে সরে যেতে পারেন",
    },
    {
        question: "স্কলারশিপ হতে কত সময় লাগতে পারে?",
        answer:
            "স্কলারশিপ এটা একটা ভাগ্য এবং মেধার কাজ.. ২/৩ বছর লাগাতার ট্রাই করতে হবে.. এবং অবশ্যই মেধাবী এবং ভালো ফলাফলের অধিকারি হতে হবে",
    },
    {
    ...
    <p>
        কিন্তু আমাদের ক্ষেত্রে এরকম নয়। আমাদের পুরো এজেন্সি ঢাকায়, আমাদের সরকার অনুমোদিত লাইসেন্স আছে এবং অফিস রয়েছে, তাই আমাদেরকে সন্দেহ করার কোনো অবকাশ নেই।
    </p>
    <p>
