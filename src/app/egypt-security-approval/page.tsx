                        ...
                        <div className="grid gap-6 lg:grid-cols-[0.72fr_1.28fr]">
                            <div>
                                ...
                                <p className="mt-4 leading-8 text-slate-600">
                                    মিশর ভ্রমণের আগে আপনার ভিসা যোগ্যতা ও ভ্রমণ রুট বুঝে নেওয়া জরুরি। এতে বোর্ডিং,
                                    এয়ারপোর্ট ইমিগ্রেশন এবং অন-অ্যারাইভাল ভিসা সংক্রান্ত প্রস্তুতি পরিষ্কার থাকে।
                                </p>
                            </div>
