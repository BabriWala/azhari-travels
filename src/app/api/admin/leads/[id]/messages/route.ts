...
export async function POST(request: NextRequest, context: Context) {
    ...
    const text = String(form.get("text") || "").trim(), party = String(form.get("party")), author = party === "staff" ? (await getAdminActor(request))!.name : String(form.get("author") || "Customer").trim();
