...
const steps = [
    {
        ...
        text: "আপনার কাছে উপরের যাবতীয় ডকুমেন্টস প্রস্তুত থাকে, তাহলে প্রথমে আপনাকে 25% টাকা অগ্রিম দিয়ে আপনার ওমরাহ ভিসার জন্য আবেদন করা হবে",
    },
    {
        step: "দ্বিতীয় ধাপ",
        amount: "50% টাকা",
        title: "টিকেট প্রদান",
        text: "ওমরাহ ভিসা অনুমোদন হওয়ার পর আপনাকে আরো 50% টাকা প্রদান করতে হবে। এই ধাপে আপনার ঢাকা থেকে সৌদি আরবের যাবতীয় ডকুমেন্টস নিশ্চিত করা হবে",
    },
    {
        step: "তৃতীয় ধাপ",
        amount: "40,000 টাকা",
        title: "মিশরের ডকুমেন্টস",
        text: "ফ্লাইট এর আগে বাকি 25% টাকা পরিশোধ করার পর, সৌদি আরব এ পৌছানোর পর আপনাকে সৌদি থেকে মিশরের টিকেট ও ওকে টু বোর্ড প্রদান করা হবে",
    },
    {
        step: "চতুর্থ ধাপ",
        amount: "আগমন সমর্থন",
